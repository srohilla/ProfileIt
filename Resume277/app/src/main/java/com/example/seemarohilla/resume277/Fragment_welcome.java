...
public class Fragment_welcome extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myFragmentView = inflater.inflate(R.layout.welcome_layout, container, false);
        ...
        TextView textView = (TextView) myFragmentView.findViewById(R.id.welcomeText);
        textView.setTypeface(TypeFace2);
        textView.setText("Life of an Engineer");
